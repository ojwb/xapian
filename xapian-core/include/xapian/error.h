...
class XAPIAN_VISIBILITY_DEFAULT AssertionError : public LogicError {
  public:
     ...
     */
    explicit AssertionError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT InvalidArgumentError : public LogicError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit InvalidArgumentError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT InvalidOperationError : public LogicError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit InvalidOperationError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT UnimplementedError : public LogicError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit UnimplementedError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseCorruptError : public DatabaseError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseCorruptError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseCreateError : public DatabaseError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseCreateError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseLockError : public DatabaseError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseLockError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseModifiedError : public DatabaseError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseModifiedError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseOpeningError : public DatabaseError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseOpeningError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseVersionError : public DatabaseOpeningError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseVersionError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DocNotFoundError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DocNotFoundError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT FeatureUnavailableError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit FeatureUnavailableError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT InternalError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit InternalError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT NetworkError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit NetworkError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT NetworkTimeoutError : public NetworkError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit NetworkTimeoutError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT QueryParserError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit QueryParserError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT SerialisationError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit SerialisationError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT RangeError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit RangeError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT WildcardError : public RuntimeError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit WildcardError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseNotFoundError : public DatabaseOpeningError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseNotFoundError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
...
class XAPIAN_VISIBILITY_DEFAULT DatabaseClosedError : public DatabaseError {
  public:
     ...
     *  @param errno_		Optional errno value associated with this error.
     */
    explicit DatabaseClosedError(std::string_view msg_, std::string_view context_ = {}, int errno_ = 0)
