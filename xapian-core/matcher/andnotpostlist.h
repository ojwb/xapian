#ifndef XAPIAN_INCLUDED_MATCHER_ANDNOTPOSTLIST_H
#define XAPIAN_INCLUDED_MATCHER_ANDNOTPOSTLIST_H

#include "api/postlist.h"

class MultiMatch;

class AndNotPostList : public PostList {
  public:
    AndNotPostList(PostList*, PostList*, MultiMatch*, Xapian::doccount) { }
