#ifndef XAPIAN_INCLUDED_MATCHER_ANDMAYBEPOSTLIST_H
#define XAPIAN_INCLUDED_MATCHER_ANDMAYBEPOSTLIST_H

#include "api/postlist.h"

class MultiMatch;

class AndMaybePostList : public PostList {
  public:
    AndMaybePostList(PostList*, PostList*, MultiMatch*, Xapian::doccount) { }
